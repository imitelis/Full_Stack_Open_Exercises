...
const blogSlice = createSlice({
    ...
    reducers: {
      ...
      refreshBlogs: (state, action) => {
        return state.filter(blog => (blog.id === action.payload.id ? { ...blog, likes: action.payload.likes } : blog))
      },
...
export const { appendBlogs, prependBlogs, refreshBlogs, setBlogs } = blogSlice.actions
